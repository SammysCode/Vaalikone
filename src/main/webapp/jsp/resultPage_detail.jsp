					...
					<div class="container" style="padding: 24px">
						<table class="table table-responsive-stack">
							...
							<tbody>
								...
								<%
									//List<QuestionAnswersObj> resultsArrayList = (ArrayList<QuestionAnswersObj>) request.getAttribute("answersList");
								//ArrayList<QuestionAnswersObj> politicianAnswers =(ArrayList<QuestionAnswersObj>) request.getAttribute("politicianAnswers");
